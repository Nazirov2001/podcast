...
import uz.bdm.podcast.databinding.PodcastBrowseItemLayoutBinding
...
class BrowsePodcastAdapter(val list: ArrayList<PodcastModel>) :
    RecyclerView.Adapter<BrowsePodcastAdapter.ItemHolder>() {

    inner class ItemHolder(val binding: PodcastBrowseItemLayoutBinding) :
        RecyclerView.ViewHolder(binding.root)

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ItemHolder {
        return ItemHolder(
            PodcastBrowseItemLayoutBinding.inflate(
